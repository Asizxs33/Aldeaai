            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                        {getTranslation(language, 'whatsappHelp')}
                    </h1>
                    <p className="text-gray-500 dark:text-gray-400">Get help via WhatsApp</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700">
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                        Direct WhatsApp support integration is under development
                    </p>
                </div>
            </div>
        </div>
